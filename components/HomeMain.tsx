    ...
    <main id="target_content">
      <div className="px-2.5 md:px-10">
                  ...
                  <div key={item.href} className="border-t border-black">
                    <div className="py-2 cursor-pointer select-none js-open-as-overlay" data-href={item.href}>
                      <div className="relative pr-16">
                        ...
                        <Link href={item.href} className="absolute right-0 top-2 text-brand-accent js-open-as-overlay">詳情</Link>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="mt-16 px-2.5 md:px-10">
          <div className="max-w-6xl mx-auto">
            <div>
              <div className="relative border-b border-black pb-2 js-accordion-toggle" role="button" tabIndex={0} aria-expanded="true" aria-label="課程資料">
                <div className="w-2/3" aria-hidden="true">
                  <p>
                    <strong>課程資料</strong>
                  </p>
                  ...
                  <div key={d.href} className="border-t border-black">
                    <div className="py-2">
                      <a href={d.href} className="relative block text-black">
                        ...
                        <span className="absolute right-0 top-0 text-brand-accent">下載</span>
                      </a>
                    </div>
                  </div>
                ))}
        ...
        <div className="mt-16 px-2.5 md:px-10">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="[text-indent:23px]">
              「攝影不僅是技術，更是一門藝術。透過光影的捕捉與底片的化學反應，我們記錄並創造出永恆的瞬間。」 – 大片幅攝影大師 (2025)
              <br />
              <br />
              <br />
            ...
            <p className="[text-indent:23px]">除了基礎與進階攝影課程外，我們還提供專業攝影師認證計劃。完成所有課程並通過實務考核的學員，將獲得本平台頒發的專業攝影師認證資格。</p>
            <p className="[text-indent:23px]">
